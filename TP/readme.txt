...
the user takes coffee orders from customers and make their orders while also 
...
their customer’s orders. In the end, the user is graded on all of their orders 
and receives a score, which after they can choose to replay the game. 

How to run:
Download the TP folder and add CMU Graphics to it. Then open the Python file
named "Capy's Coffee.py" in VS Code and hold command+b to run the file. Make sure 
that everything including CMU Graphics stays inside the main folder, do not move
images out from the folders they are inside of.
